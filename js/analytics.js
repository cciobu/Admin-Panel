document.addEventListener("DOMContentLoaded", () => {
    ...
    if (!clients || clients.length === 0) {
        console.warn("Nu există clienți în LocalStorage. Adăugăm date de test.");
        clients = [
    ...
    const clientsChart = new Chart(ctxClients, {
        ...
        options: {
            ...
            aspectRatio: 1.5, // Reducem raportul pentru a face graficul mai compact
            plugins: {
    ...
    const ordersByMonthYearChart = new Chart(ctxOrders, {
        ...
        options: {
            responsive: true,
            maintainAspectRatio: true,
            aspectRatio: 2, // Ajustăm pentru a fi mai lat și mai puțin înalt
            plugins: { 
    ...
    const ordersTrendChart = new Chart(ctxTrend, {
        ...
        options: {
            responsive: true,
            maintainAspectRatio: true,
            aspectRatio: 2, // Ajustăm pentru a reduce înălțimea
            plugins: { 
                legend: { display: true }, 
